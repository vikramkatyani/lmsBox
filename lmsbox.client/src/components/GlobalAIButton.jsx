...
const GlobalAIButton = () => {
  ...
  return (
    <button
      onClick={handleClick}
      className="fixed bottom-6 right-6 z-50 bg-boxlms-navbar text-boxlms-navbar-txt p-4 rounded-full shadow-lg hover:shadow-xl hover:brightness-110 transition-all duration-200 flex items-center gap-2 group"
