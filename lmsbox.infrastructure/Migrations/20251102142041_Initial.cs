        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActivatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LearningGroups", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LearningGroups_AspNetUsers_CreatedByUserId",
                        column: x => x.CreatedByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LearningGroups_Organisations_OrganisationId",
                        column: x => x.OrganisationId,
                        principalTable: "Organisations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CourseAssignments_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CourseAssignments_AspNetUsers_AssignedByUserId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourseAssignments_LearningGroups_LearningGroupId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GroupCourses_LearningGroups_LearningGroupId",
                        column: x => x.LearningGroupId,
                        principalTable: "LearningGroups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LearnerGroups_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LearnerGroups_LearningGroups_LearningGroupId",
                        column: x => x.LearningGroupId,
                        principalTable: "LearningGroups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LearnerProgresses_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseAssignments_ApplicationUserId",
                table: "CourseAssignments",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_CourseAssignments_AssignedByUserId",
                table: "CourseAssignments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseAssignments_LearningGroupId",
                table: "CourseAssignments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupCourses_LearningGroupId",
                table: "GroupCourses",
                column: "LearningGroupId");

            migrationBuilder.CreateIndex(
                name: "IX_LearnerGroups_LearningGroupId",
                table: "LearnerGroups",
                column: "LearningGroupId");

            migrationBuilder.CreateIndex(
                name: "IX_LearnerGroups_UserId",
                table: "LearnerGroups",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LearningGroups_CreatedByUserId",
                table: "LearningGroups",
                column: "CreatedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_LearningGroups_OrganisationId",
                table: "LearningGroups",
                column: "OrganisationId");
