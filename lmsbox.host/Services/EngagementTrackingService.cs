...
namespace lmsBox.Server.Services
{
    public class EngagementTrackingService : IEngagementTrackingService
    {
        ...
        public const string LOGIN_METHOD_MAGIC_LINK = "MagicLink";
        public const string LOGIN_METHOD_GOOGLE = "Google";
        public const string LOGIN_METHOD_MICROSOFT = "Microsoft";
        public const string LOGIN_METHOD_DEV = "Dev";
        public const string LOGIN_METHOD_EXTERNAL = "ExternalSso";
        public const string LOGIN_METHOD_ADMIN_LINK = "AdminLink";
        ...
        public const string EVENT_LESSON_PROGRESS_UPDATED = "LessonProgressUpdated";

        public const string EVENT_QUESTION_BANK_QUESTION_CREATED = "QuestionBankQuestionCreated";
        public const string EVENT_QUESTION_BANK_QUESTION_UPDATED = "QuestionBankQuestionUpdated";
        public const string EVENT_QUESTION_BANK_QUESTION_DELETED = "QuestionBankQuestionDeleted";
        public const string EVENT_QUESTION_BANK_QUESTION_ARCHIVED = "QuestionBankQuestionArchived";
        public const string EVENT_QUESTION_BANK_CATEGORY_CREATED = "QuestionBankCategoryCreated";
        public const string EVENT_QUESTION_BANK_CATEGORY_UPDATED = "QuestionBankCategoryUpdated";
        public const string EVENT_QUESTION_BANK_CATEGORY_DELETED = "QuestionBankCategoryDeleted";
        public const string EVENT_QUESTION_BANK_QUIZ_CREATED = "QuestionBankQuizCreated";
        public const string EVENT_QUESTION_BANK_QUIZ_UPDATED = "QuestionBankQuizUpdated";
        public const string EVENT_QUESTION_BANK_QUIZ_DELETED = "QuestionBankQuizDeleted";

        public const string EVENT_QUIZ_CREATED = "QuizCreated";
        public const string EVENT_QUIZ_UPDATED = "QuizUpdated";
        public const string EVENT_QUIZ_DELETED = "QuizDeleted";
        public const string EVENT_QUIZ_IMPORTED_FROM_BANK = "QuizImportedFromBank";
